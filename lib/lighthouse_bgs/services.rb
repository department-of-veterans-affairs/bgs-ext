...
require 'lighthouse_bgs/services/vnp_bnft_claim'
require 'lighthouse_bgs/services/vnp_child_school'
require 'lighthouse_bgs/services/vnp_child_student'
require 'lighthouse_bgs/services/vnp_person'
require 'lighthouse_bgs/services/vnp_proc_form'
require 'lighthouse_bgs/services/vnp_proc_v2'
require 'lighthouse_bgs/services/vnp_ptcpnt'
require 'lighthouse_bgs/services/vnp_ptcpnt_addrs'
require 'lighthouse_bgs/services/vnp_ptcpnt_phone'
require 'lighthouse_bgs/services/vnp_ptcpnt_rlnshp'
