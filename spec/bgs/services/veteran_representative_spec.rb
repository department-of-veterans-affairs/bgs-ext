...
describe BGS::DisabilityContentionService do # rubocop:disable Metrics/BlockLength
    ...
    it 'get read_all_veteran_representatives' do
      VCR.use_cassette('veteran_representative/read_all_veteran_representatives') do
        response = service.veteran_representative.read_all_veteran_representatives(form_type_code: '21-22', veteran_corp_ptcpnt_id: participant_id)
        # response = service.veteran_representative.read_all_veteran_representatives(form_type_code: '21-22', veteran_corp_ptcpnt_id: 150191)
